...
class MultiModalAISafetyDatasetProvider(DatasetProvider):
    ...
    def _load_fakenews_data(self, dataset_path: Path) -> pd.DataFrame:
        ...
        if politifact_fake.exists() and politifact_real.exists():
            print("Loading Politifact dataset from existing files")
        ...
        # Try to load from existing BuzzFeed files
            ...
            print("Loading BuzzFeed dataset from existing files")
        ...
        for text in texts:
            ...
            if len(tokenized_examples) == 0:  # Only print for first sample
                ...
                if non_masked_count == 0:
                    print("WARNING: All tokens are masked! This will cause training issues.")
...
class MultiModalAISafetyPlugin:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        print("Multi-Modal AI Safety + TinyLlama plugin initialized")
        ...
        print("   Objectives: Detection Accuracy, Fake News Recall, Real News Precision, Cross-Source Robustness, Confidence Calibration, Efficiency")
    ...
    def _comprehensive_baseline_comparison(self, best_genome, baseline_config):
        ...
        print("Running comprehensive baseline vs LoRA comparison...")
    ...
    def _simple_adapter_test(self, best_genome, test_samples: int = 10):
        """Simple adapter test."""
        print("Running simple adapter test...")
