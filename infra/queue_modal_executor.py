...
class QueueModalExecutor(Executor):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        print(f"🧮 QueueModalExecutor initialized with category theory compliance")
        print(f"   App: {self.app_name}")
        print(f"   Global queues: coral-training, coral-test, coral-generation, coral-results")
            ...
            try:
                ...
                if job_id in self.pending_jobs:
                    ...
                    if orphan_count >= 3:
                        ...
                        print(f"     This suggests multiple evaluation processes are running.")
                        print(f"     Consider restarting the experiment to ensure clean state.")
