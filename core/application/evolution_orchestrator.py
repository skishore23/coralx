...
from ..domain.experiment import create_initial_population
...
class EvolutionOrchestrator(LoggingMixin):
    ...
    async def _initialize_population(self) -> Population:
        ...
        # Function signature is wrong - it needs the full config despite the type hint
        population = create_initial_population(
            config=self.config,  # Pass full config despite type hint saying ExperimentConfig
