...
class BaselineEvaluator:
    ...
    def compare_baseline_vs_lora(self, base_model, tokenizer, lora_adapter_path: str) -> ComparisonResults:
        ...
        try:
            ...
            lora_results = self.evaluate_model(lora_model, tokenizer, "LORA")
    ...
    def print_detailed_results(self, comparison: ComparisonResults) -> None:
        ...
        print("\n" + "="*60)
        print("📊 BASELINE vs LORA PERFORMANCE COMPARISON")
        print("="*60)
        ...
        if comparison.is_significant_improvement:
            print("✅ SUCCESS: Your evolved LoRA adapter shows meaningful improvement!")
            print("💪 The evolutionary process is working effectively")
        else:
            print("⚠️  LIMITED SUCCESS: Improvement is minimal")
            print("💡 Consider: more training data, longer training, or different LoRA configuration")
